...
public:
	...
	__forceinline bool did_not_hit_entity( ) const {
...
public:
	...
	__forceinline void ClipRayToEntity( const Ray_t& ray, uint32_t mask, Entity* entity, CGameTrace* trace ) {
		return util::get_method< void( __thiscall* )( decltype( this ), const Ray_t&, uint32_t, Entity*, CGameTrace* ) >( this, CLIPRAYTOENTITY )( this, ray, mask, entity, trace );
	}
	...
	__forceinline void TraceRay( const Ray_t& ray, uint32_t mask, ITraceFilter* filter, CGameTrace* trace ) {
		return util::get_method< void( __thiscall* )( decltype( this ), const Ray_t&, uint32_t, ITraceFilter*, CGameTrace* ) >( this, TRACERAY )( this, ray, mask, filter, trace );
	}
};
...
namespace AnimationFixx {
	...
	public:
		...
		void SimulateAnimations( Encrypted_t<C_AnimationRecord> current, Encrypted_t<C_AnimationRecord> previous );
		...
		alignas( 16 ) matrix3x4_t m_Bones[ 128 ]{ };
		alignas( 16 ) BoneArray m_Bones2[ 128 ]{ };
		float m_flAbsRotation;
	};

	class __declspec( novtable ) AnimationSystem : public LagController::NonCopyable {
	public:
